...
public class MaintenanceList : MonoBehaviour
{
    ...
    [Header("��� �ؽ�Ʈ")]
    public TMP_Text statsText;            // "�� N�� �� ������ N�� �� ��� N��"
    ...
    void OnEnable()
    {
        Debug.Log("[Maintenance] OnEnable ȣ���");
    ...
    {
        Debug.Log("[Maintenance] FetchList ����");
        ...
        foreach (string status in statuses)
        {
            ...
            Debug.Log("[Maintenance] ��û URL: " + url);
            ...
            using (UnityWebRequest req = UnityWebRequest.Get(url))
            {
                ...
                {
                    Debug.LogError("[Maintenance] ��û ����: " + req.error);
                    continue;
                }
    ...
    private void RenderPage()
    {
        ...
        if (statsText)
            statsText.text = $"�� {total}�� �� ������ {inProgress}�� �� ��� {scheduled}�� �� �Ϸ� {completed}��";
